...
namespace FIMSpace.Generating
{
    ...
    public class PGG_MinimapDisplayController : MonoBehaviour
    {
        ...
        private void  FollowPosition(Vector3 followWorldPosition)
        {
        ...
        public void MoveUp() => TargetPosition += Vector3.forward * MoveStep;
        public void MoveDown() => TargetPosition += Vector3.back * MoveStep;
        public void MoveLeft() => TargetPosition += Vector3.left * MoveStep;
        public void MoveRight() => TargetPosition += Vector3.right * MoveStep;
        public void ZoomIn() => ZoomInBy(ZoomStep);
        public void ZoomOut() => ZoomInBy(-ZoomStep);
