        ...
        public void GenerateAfterPlannerExecutor()
        {
            ...
            for (int g = 0; g < Executor.GeneratedGenerators.Count; g++)
            {
                ...
                if (bSettings.JustImage)
                {
                    ...
                    if (imagePf)
                    {
                        Debug.LogError("Generation is here");
